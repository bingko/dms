<div class="row">
  <div class="col-lg-12">
    <div style="float:left">
      <h2> Roll in intermediate </h2>
    </div>
    <div style="float:right"><br />
      <a href="<?php echo base_url() ?>files/22-12-2557.xls" target="_blank">
                ...
                <tr>
                  ...
                  <td width="<?php echo 100/($countMonth+1)?>%"><div align="center">
					  ...
					  if($datetime2->format('m/Y')==$month_header->format('m/Y')){ 
					  	echo "<a href='".site_url('home/result_detail/'.$value['Rollid2'].'/'.$setDate['start_date'].'/'.$setDate['end_date'].'/intermediate/0')."' target='_blank'>";
                  ...
                  <td width="<?php echo 100/($countMonth+1)?>%"><div align="center"><strong>
                      <?php 
												...
												if($datetime3->format('m/Y')==$month_num->format('m/Y')){ 
													echo "<a href='".site_url('home/result_detail/'.$value['Rollid2'].'/'.$setDate['start_date'].'/'.$setDate['end_date'].'/intermediate/1')."' target='_blank'>";
