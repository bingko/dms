...
class nplan4_model extends CI_Model {

	
	public function list_allnplan_ct1()
	{
		$this->db->where('cut_size',1);
		$query = $this->db->get('nplan4');
        if ($query->num_rows() > 0) {
	...
	public function get_pallet_done($InData)
	{
