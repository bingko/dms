...
<div class="row">
	...
	<?php echo form_open('logSheet/searchfolioLog');?>
					<div id="date">
						<div class="row">
	...
	<div class="row">
		<div class="col-lg-12">
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
				<?php $total_downtime = 0;
				foreach($downtime as $key => $value){ ?>
					<tr>
						<td><?php echo $value['problem_name'] ?></td>
						<td><?php echo $total_downtime = $value['shift1']+$value['shift2']+$value['shift3']; ?></td>
						<td></td>
					</tr>
				<?php } ?>
                <tr>
						<td><strong>Machine Down Time</strong> </td>
