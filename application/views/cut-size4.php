        ...
        <div id="page-wrapper">
                ...
                <div class="panel panel-primary">
                            ...
                            <div class="panel-heading">
                                ...
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> <strong>Cut Size 4</strong> </h3>
    
                                 <div class="panel-title" style="float:right; position:relative;top:-20px;">
                                    <a href="<?php echo site_url('dashboard/detail_cut_size4/4')?>" target="_blank"><i class="fa fa-arrow-circle-right"></i></a>
                                </div>
