         ...
         <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <tr width=100> 
                    ...
                    <td height="50" align="center">    <input type="text" class="form-control textbox" name="grade_gram" placeholder="เกรด/แกรม"
                    value="<?php echo $detail_CutSite[0]['grade_gram'] ?>" >  </td>
                 ...
                 <tr width=100> 
                  ...
                  <tr width=100> 
                    ...
                    <td height="50" align="center">     <input type="text" class="form-control textbox" name="mat_no" placeholder="M/C speed "
    ...
    <div class="panel panel-green">
        ...
        <div class="panel-body">
			...
			<div class="row">
                ...
                <div class="col-sm-10">
                   	<textarea name="remark" class="form-control"><?php echo$detail_remark[0]['remark'] ?></textarea>
                </div>
            </div>
...
<div align="center"> 
    ...
    <button type="submit" class="btn btn-primary">แก้ไขข้อมูล</button>  </div>
</div>
</div><br />
